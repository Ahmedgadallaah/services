...
<div class="card-body" id="english-form">
    <div class="form-group">
        ...
        <input class="form-control {{ $errors->has('en_location') ? 'is-invalid' : '' }}" type="text" name="en_location" id="en_location" value="{{ old('en_location', '') }}" required>
    ...
    <div class="form-group">
        ...
        <input class="form-control {{ $errors->has('ar_location') ? 'is-invalid' : '' }}" type="text" name="ar_location" id="ar_location" value="{{ old('ar_location', '') }}" required>
